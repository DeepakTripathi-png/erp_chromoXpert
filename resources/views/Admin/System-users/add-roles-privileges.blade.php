                                    ...
                                    <table class="table table-hover table-bordered" id="role-privileges-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="fade-in-row">
                                                ...
                                                <td>Pets</td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="animals_view" class="ccheckbox view" value="animals_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'animals_view') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="animals_add" class="ccheckbox add" value="animals_add" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'animals_add') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="animals_edit" class="ccheckbox edit" value="animals_edit" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'animals_edit') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="animals_delete" class="ccheckbox deletes" value="animals_delete" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'animals_delete') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="animals_status_change" class="ccheckbox status" value="animals_status_change" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'animals_status_change') ? 'checked' : '' }}></td>
                                                <td class="text-center"></td>
                                            </tr>
                                            <tr class="fade-in-row">
                                                <td class="text-center">12</td>
                                                <td>Test Management</td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="test_management_view" class="ccheckbox view" value="test_management_view" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'test_management_view') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="test_management_add" class="ccheckbox add" value="test_management_add" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'test_management_add') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="test_management_edit" class="ccheckbox edit" value="test_management_edit" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'test_management_edit') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="test_management_delete" class="ccheckbox deletes" value="test_management_delete" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'test_management_delete') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="test_management_status_change" class="ccheckbox status" value="test_management_status_change" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'test_management_status_change') ? 'checked' : '' }}></td>
                                                <td class="text-center"></td>
                                            </tr>
                                            <tr class="fade-in-row">
