...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{URL::asset('ims_assets/images/construction_inventory.png')}}">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-4">
                    <div class="text-center">
                        <a href="">
                            <img src="{{URL::asset('ims_assets/images/construction_inventory.png')}}" alt="" height="25" class="mx-auto">
                        </a>
