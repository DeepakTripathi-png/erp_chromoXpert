...
class BranchController extends Controller
{
    ...
    public function add(){
        ...
        return view('Admin.Branches.add-branches',compact('labincharge')); 
    }
    ...
    //         if (!empty($request->id)) {
    //             if (!empty($RolesPrivileges) && str_contains($RolesPrivileges->privileges, 'branches_edit')) {
    ...
    //         } else {
    //             // CREATE logic
    //             if (!empty($RolesPrivileges) && str_contains($RolesPrivileges->privileges, 'branches_add')) {
    ...
    //         ->where('status', '!=', 'delete')
    //         ->orderBy('id', 'DESC')
    //         ->select('id', 'branch_code', 'branch_name', 'email', 'mobile', 'address', 'lab_incharge', 'status')
    //         ->get();
    ...
    //             })
    //             ->addColumn('test_cases', function ($row) {
    //                 return rand(500, 2000); // Placeholder; replace with actual logic
    //             })
    //             ->addColumn('bookings', function ($row) {
    //                 return rand(300, 1500); // Placeholder; replace with actual logic
    //             })
    ...
    //                 if (!empty($RolesPrivileges) && str_contains($RolesPrivileges->privileges, 'branches_status_change')) {
    //                     return '<label class="switch">
    //                                 <input type="checkbox" class="change-status" data-id="' . $row->id . '" data-table="branches" data-flash="Status Changed Successfully!" ' . $isChecked . '>
    ...
    //                 // View button
    //                 if (!empty($RolesPrivileges) && str_contains($RolesPrivileges->privileges, 'branches_view')) {
    ...
    public function data_table(Request $request)
   {
    ...
    {
        $branch = Branch::with(['country', 'state', 'city', 'labIncharge'])->find($id);
        if (!$branch) {
            return redirect('admin/branches')->with('error', 'Branch not found!');
        }
